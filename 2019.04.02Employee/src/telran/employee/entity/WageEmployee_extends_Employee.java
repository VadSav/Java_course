...
public class WageEmployee_extends_Employee extends Employee {
	private double wage;

	public WageEmployee_extends_Employee(int id, String firstName, String lastName,
	...
	public String toString() {
		return "WageEmployee [wage=" + wage + ", toString()="
				+ super.toString() + "]";
	}
